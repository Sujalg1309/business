...
function payStaff() {
    ...
    let totalPrice = StaffQuantity * getCurrentCityPrices('Staff');
        ...
        if (gameState.money >= totalPrice) {
            ...
            gameState.money -= totalPrice;
            StaffAmountInput.value = ""; // Clear the input field
            saveState();
            updateDisplay();
        } else {
            alert(`You don't have enough money to pay Staff!`);
        }
}
function payTaxes() {
    ...
    let totalPrice = TaxesQuantity * getCurrentCityPrices('Taxes');
        ...
        if (gameState.money >= totalPrice) {
            ...
            gameState.money -= totalPrice;
            TaxesAmountInput.value = ""; // Clear the input field
            saveState();
            updateDisplay();
        } else {
...
function changeCity(cityName) {
    const cities = {
        "New York": { fuelCost: 0, staffModifier: 1.5, taxesModifier: 1.2, imgSrc: "BUSINESS/page/data/data/1/media/New Yerk.jpg" },
        "Los Angeles": { fuelCost: 10, staffModifier: 1.8, taxesModifier: 1.3, imgSrc: "BUSINESS/page/data/data/1/media/ls.jpg" },
        "San Francisco": { fuelCost: 15, staffModifier: 1.2, taxesModifier: 1.1, imgSrc: "BUSINESS/page/data/data/1/media/sf.jpg" }
    };
